...
if __name__ == "__main__":
    ...
    try:        
        ...
        time.sleep(0.5)
        xtp.xbee.send_cmd("at", command=b'CM', parameter=struct.pack(">Q", 0xffe7f4f430000000))
        xtp.xbee.send_cmd("at", command=b'HP', parameter=b'\x03')
        xtp.xbee.send_cmd("at", command=b'PL', parameter=b'\x04')
        xtp.xbee.send_cmd("at", command=b'CM')
